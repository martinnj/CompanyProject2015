...
\input{00_intro}                % Inroduction to the project.
\input{01_companystructure}     % Description of the company structure and workflow.
\input{02_problem_desc}         % Description of the problem.
\input{03_problem_analysis}     % Analysis and solution of the problem area.
\input{04_results}              % Selected solution and work done. Includes results of work.
\input{05_competencies_methods} % Competencies and methods.
\input{06_conclusion}           % Final conclusion.
